...
#        self.Kappa_pred5 = self.net_Kappa5(self.t_u)
        ...
        self.lossU = 200*tf.reduce_mean(tf.square(self.I_new_u[:-1,:] - self.I_new_pred)) + \
            200*tf.reduce_mean(tf.square(self.D_new_u[:-1,:] - self.D_new_pred)) + \
            200*tf.reduce_mean(tf.square(self.H_new_u[:-1,:] - self.H_new_pred)) + \
