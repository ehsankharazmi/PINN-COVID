...
# load data
BetaI_PINN = np.loadtxt('Model1/Train-Results-'+dt_string+'-Average/BetaI_pred_mean.txt') 
p_PINN = np.loadtxt('Model1/Train-Results-'+dt_string+'-Average/p_pred_mean.txt')
q_PINN = np.loadtxt('Model1/Train-Results-'+dt_string+'-Average/q_pred_mean.txt') 
t_mean = np.arange(len(BetaI_PINN))

S_PINN = np.loadtxt('Model1/Train-Results-'+dt_string+'-Average/S_pred_mean.txt') 
S_PINN = S_PINN/sf
E_PINN = np.loadtxt('Model1/Train-Results-'+dt_string+'-Average/E_pred_mean.txt') 
E_PINN = E_PINN/sf
I_PINN = np.loadtxt('Model1/Train-Results-'+dt_string+'-Average/I_pred_mean.txt') 
I_PINN = I_PINN/sf
J_PINN = np.loadtxt('Model1/Train-Results-'+dt_string+'-Average/J_pred_mean.txt') 
J_PINN = J_PINN/sf
H_PINN = np.loadtxt('Model1/Train-Results-'+dt_string+'-Average/H_pred_mean.txt') 
H_PINN = H_PINN/sf
D_PINN = np.loadtxt('Model1/Train-Results-'+dt_string+'-Average/D_pred_mean.txt') 
D_PINN = D_PINN/sf
R_PINN = np.loadtxt('Model1/Train-Results-'+dt_string+'-Average/R_pred_mean.txt') 
R_PINN = R_PINN/sf
I_sum_PINN = np.loadtxt('Model1/Train-Results-'+dt_string+'-Average/I_sum_pred_mean.txt') 
I_sum_PINN = I_sum_PINN/sf
H_sum_PINN = np.loadtxt('Model1/Train-Results-'+dt_string+'-Average/H_sum_pred_mean.txt') 
H_sum_PINN = H_sum_PINN/sf
I_new_PINN = np.loadtxt('Model1/Train-Results-'+dt_string+'-Average/I_new_pred_mean.txt') 
I_new_PINN = I_new_PINN/sf
H_new_PINN = np.loadtxt('Model1/Train-Results-'+dt_string+'-Average/H_new_pred_mean.txt') 
H_new_PINN = H_new_PINN/sf
D_new_PINN = np.loadtxt('Model1/Train-Results-'+dt_string+'-Average/D_new_pred_mean.txt') 
...
U_init = [S_init, E_init, I_init, J_init, D_init, H_init, R_init, I_sum_init, H_sum_init]
...
def ODEs_mean_1(X, t, xi, Pert): 
    S, E, I, J,  D, H, R, sumI, sumH = X  
    dSdt = -(BetaI_PINN[-1]  * (1+xi*Pert) *(I+eps1*J+eps2*H)/N)*S - V_1(t)/N*S
    dEdt = (BetaI_PINN[-1]  * (1+xi*Pert) *(I+eps1*J+eps2*H)/N)*S - alpha*E 
    dIdt = (delta*alpha)*E - Gamma*I
    dJdt = ((1-delta)*alpha)*E - gammaA*J
    dDdt = (q_mean*phiD)*H
    dHdt = (p_mean*Gamma)*I - (q_mean*phiD) * H - ((1-q_mean)*phiR) * H
    dRdt = gammaA*J + ((1-p_mean)*Gamma)*I + ((1-q_mean)*phiR)*H + V_1(t)/N*S
    dsumIdt = (delta*alpha)*E 
    dsumHdt = (p_mean*Gamma)*I   
    return [dSdt, dEdt, dIdt, dJdt, dDdt, dHdt, dRdt, dsumIdt, dsumHdt] 
...
I_ub_d0_V1 = Sol_ub_d0_V1[:,2]   
J_ub_d0_V1 = Sol_ub_d0_V1[:,3]   
D_ub_d0_V1 = Sol_ub_d0_V1[:,4]   
H_ub_d0_V1 = Sol_ub_d0_V1[:,5]   
R_ub_d0_V1 = Sol_ub_d0_V1[:,6]   
sumI_ub_d0_V1 = Sol_ub_d0_V1[:,7] 
sumH_ub_d0_V1 = Sol_ub_d0_V1[:,8]  
...
I_lb_d0_V1 = Sol_lb_d0_V1[:,2]   
J_lb_d0_V1 = Sol_lb_d0_V1[:,3]   
D_lb_d0_V1 = Sol_lb_d0_V1[:,4]   
H_lb_d0_V1 = Sol_lb_d0_V1[:,5]   
R_lb_d0_V1 = Sol_lb_d0_V1[:,6]   
sumI_lb_d0_V1 = Sol_lb_d0_V1[:,7] 
sumH_lb_d0_V1 = Sol_lb_d0_V1[:,8]  
...
I_ub_d0_V2 = Sol_ub_d0_V2[:,2]   
J_ub_d0_V2 = Sol_ub_d0_V2[:,3]   
D_ub_d0_V2 = Sol_ub_d0_V2[:,4]   
H_ub_d0_V2 = Sol_ub_d0_V2[:,5]   
R_ub_d0_V2 = Sol_ub_d0_V2[:,6]   
sumI_ub_d0_V2 = Sol_ub_d0_V2[:,7] 
sumH_ub_d0_V2 = Sol_ub_d0_V2[:,8]  
...
I_lb_d0_V2 = Sol_lb_d0_V2[:,2]   
J_lb_d0_V2 = Sol_lb_d0_V2[:,3]   
D_lb_d0_V2 = Sol_lb_d0_V2[:,4]   
H_lb_d0_V2 = Sol_lb_d0_V2[:,5]   
R_lb_d0_V2 = Sol_lb_d0_V2[:,6]   
sumI_lb_d0_V2 = Sol_lb_d0_V2[:,7] 
sumH_lb_d0_V2 = Sol_lb_d0_V2[:,8]  
...
I_ub_d1_V1 = Sol_ub_d1_V1[:,2]   
J_ub_d1_V1 = Sol_ub_d1_V1[:,3]   
D_ub_d1_V1 = Sol_ub_d1_V1[:,4]   
H_ub_d1_V1 = Sol_ub_d1_V1[:,5]   
R_ub_d1_V1 = Sol_ub_d1_V1[:,6]   
sumI_ub_d1_V1 = Sol_ub_d1_V1[:,7] 
sumH_ub_d1_V1 = Sol_ub_d1_V1[:,8]  
...
I_lb_d1_V1 = Sol_lb_d1_V1[:,2]   
J_lb_d1_V1 = Sol_lb_d1_V1[:,3]   
D_lb_d1_V1 = Sol_lb_d1_V1[:,4]   
H_lb_d1_V1 = Sol_lb_d1_V1[:,5]   
R_lb_d1_V1 = Sol_lb_d1_V1[:,6]   
sumI_lb_d1_V1 = Sol_lb_d1_V1[:,7] 
sumH_lb_d1_V1 = Sol_lb_d1_V1[:,8]  
...
I_ub_d1_V2 = Sol_ub_d1_V2[:,2]   
J_ub_d1_V2 = Sol_ub_d1_V2[:,3]   
D_ub_d1_V2 = Sol_ub_d1_V2[:,4]   
H_ub_d1_V2 = Sol_ub_d1_V2[:,5]   
R_ub_d1_V2 = Sol_ub_d1_V2[:,6]   
sumI_ub_d1_V2 = Sol_ub_d1_V2[:,7] 
sumH_ub_d1_V2 = Sol_ub_d1_V2[:,8]  
...
I_lb_d1_V2 = Sol_lb_d1_V2[:,2]   
J_lb_d1_V2 = Sol_lb_d1_V2[:,3]   
D_lb_d1_V2 = Sol_lb_d1_V2[:,4]   
H_lb_d1_V2 = Sol_lb_d1_V2[:,5]   
R_lb_d1_V2 = Sol_lb_d1_V2[:,6]   
sumI_lb_d1_V2 = Sol_lb_d1_V2[:,7] 
sumH_lb_d1_V2 = Sol_lb_d1_V2[:,8]  
...
I_mean_V1 = Sol_mean_V1[:,2]   
J_mean_V1 = Sol_mean_V1[:,3]   
D_mean_V1 = Sol_mean_V1[:,4]   
H_mean_V1 = Sol_mean_V1[:,5]   
R_mean_V1 = Sol_mean_V1[:,6]   
sumI_mean_V1 = Sol_mean_V1[:,7] 
sumH_mean_V1 = Sol_mean_V1[:,8]  
...
I_mean_V2 = Sol_mean_V2[:,2]   
J_mean_V2 = Sol_mean_V2[:,3]   
D_mean_V2 = Sol_mean_V2[:,4]   
H_mean_V2 = Sol_mean_V2[:,5]   
R_mean_V2 = Sol_mean_V2[:,6]   
sumI_mean_V2 = Sol_mean_V2[:,7] 
sumH_mean_V2 = Sol_mean_V2[:,8]  
